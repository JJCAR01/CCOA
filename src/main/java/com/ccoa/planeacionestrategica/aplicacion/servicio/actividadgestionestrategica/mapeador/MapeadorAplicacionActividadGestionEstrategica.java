...
public class MapeadorAplicacionActividadGestionEstrategica implements MapeadorAplicacion<DtoActividadGestionEstrategica, ActividadGestionEstrategica> {
    ...
    public ActividadGestionEstrategica mapeadorAplicacionDuplicar(DtoActividadGestionEstrategica dto, Long idActividadEstrategica, LocalDate fechaInicial,LocalDate fechaFinal) {

        return ActividadGestionEstrategica.of(dto.getIdActividadGestionEstrategica(),dto.getNombre(),fechaInicial,fechaFinal,
                servicioObtenerHoraActual.calcular(dto.getFechaRegistro()), dto.getIdUsuario(), idActividadEstrategica);
    }
}
