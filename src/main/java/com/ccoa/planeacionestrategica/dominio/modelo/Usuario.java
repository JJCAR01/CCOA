...
public class Usuario {
    ...
    public static Usuario of(String nombre,String apellido,String password,String correo,Long idCargo, List<Rol> roles){
        ...
        return new Usuario(nombre,apellido,password,correo,idCargo,roles);
    }

    public Usuario(String nombre, String apellido, String password, String correo, Long idCargo, List<Rol> roles) {
        this.nombre = nombre;
