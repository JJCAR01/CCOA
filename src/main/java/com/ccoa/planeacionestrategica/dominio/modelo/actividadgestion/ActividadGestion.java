...
public class ActividadGestion {
    ...
    public static ActividadGestion of(Long idActividadGestion, String nombre, LocalDate fechaInicial, LocalDate fechaFinal, Long idUsuario, Long idPat){
        ...
        return new ActividadGestion(idActividadGestion, nombre, fechaInicial, fechaFinal, idUsuario, idPat);
    }

    public ActividadGestion(Long idActividadGestion, String nombre, LocalDate fechaInicial, LocalDate fechaFinal, Long idUsuario, Long idPat) {
