...
public class InformacionActividadGestion {
    ...
    public static InformacionActividadGestion of(LocalDate fechaRegistro, Integer duracion, Integer diasRestantes, Double avance){
        ...
        return new InformacionActividadGestion(fechaRegistro,duracion,diasRestantes,avance);
    }
    public InformacionActividadGestion(LocalDate fechaRegistro, Integer duracion, Integer diasRestantes, Double avance) {
