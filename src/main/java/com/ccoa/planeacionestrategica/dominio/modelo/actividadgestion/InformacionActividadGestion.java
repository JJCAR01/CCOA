...
public class InformacionActividadGestion {
    ...
    public static InformacionActividadGestion of(Integer duracion, Integer diasRestantes, double porcentajeReal,
        ...
        return new InformacionActividadGestion(duracion, diasRestantes, porcentajeReal, porcentajeEsperado, porcentajeCumplimiento);
    }

    public InformacionActividadGestion(Integer duracion, Integer diasRestantes, double porcentajeReal, double porcentajeEsperado, double porcentajeCumplimiento) {
