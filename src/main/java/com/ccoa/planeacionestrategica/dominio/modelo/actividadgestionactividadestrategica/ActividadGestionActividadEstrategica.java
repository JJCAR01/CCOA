...
public class ActividadGestionActividadEstrategica {
    ...
    public static ActividadGestionActividadEstrategica of(Long idActividadGestionActividadEstrategica, String nombre, LocalDate fechaInicial,
        ...
        return new ActividadGestionActividadEstrategica(idActividadGestionActividadEstrategica, nombre, fechaInicial, fechaFinal, fechaRegistro, idUsuario, idActividadEstrategica);
    }

    public ActividadGestionActividadEstrategica(Long idActividadGestionActividadEstrategica, String nombre,
