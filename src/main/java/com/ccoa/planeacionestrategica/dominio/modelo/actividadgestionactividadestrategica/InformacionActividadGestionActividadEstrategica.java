...
public class InformacionActividadGestionActividadEstrategica  {
    ...
    public static InformacionActividadGestionActividadEstrategica of(LocalDate fechaRegistro, Integer duracion, Integer diasRestantes, Double avance){
        ...
        return new InformacionActividadGestionActividadEstrategica(fechaRegistro,duracion,diasRestantes,avance);
    }
    public InformacionActividadGestionActividadEstrategica(LocalDate fechaRegistro, Integer duracion, Integer diasRestantes, Double avance) {
