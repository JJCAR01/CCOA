...
@Data
public class InformacionActividadGestionEstrategica  {
    ...
    public static InformacionActividadGestionEstrategica of(Integer duracion, Integer diasRestantes,
        ...
        return new InformacionActividadGestionEstrategica(duracion, diasRestantes, porcentajeReal, porcentajeEsperado, porcentajeCumplimiento);
    }

    public InformacionActividadGestionEstrategica(Integer duracion, Integer diasRestantes,
                                                           double porcentajeReal, double porcentajeEsperado, double porcentajeCumplimiento) {
