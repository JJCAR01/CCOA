...
public class InformacionProyecto {
    ...
    public static InformacionProyecto of(Long idInformacionProyecto ,LocalDate fechaInicial, LocalDate fechaFinal, Integer duracion,
        ...
        return new InformacionProyecto(idInformacionProyecto,fechaInicial, fechaFinal, duracion, planeacionSprint, totalSprint);
    }

    public InformacionProyecto(Long idInformacionProyecto , LocalDate fechaInicial, LocalDate fechaFinal, Integer duracion, EPlaneacionSprint planeacionSprint, Integer totalSprint) {
