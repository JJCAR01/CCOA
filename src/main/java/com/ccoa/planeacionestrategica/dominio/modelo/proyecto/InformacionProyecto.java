...
public class InformacionProyecto {
    ...
    public static InformacionProyecto of(LocalDate fechaInicial, LocalDate fechaFinal, Integer duracion,
        ...
        return new InformacionProyecto(fechaInicial, fechaFinal, duracion, planeacionSprint, totalSprint, idUsuario);
    }

    public InformacionProyecto(LocalDate fechaInicial, LocalDate fechaFinal, Integer duracion, EPlaneacionSprint planeacionSprint, Integer totalSprint, Long idUsuario) {
