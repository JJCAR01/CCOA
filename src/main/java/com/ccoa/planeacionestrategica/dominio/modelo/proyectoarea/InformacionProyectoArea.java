...
@Data
public class InformacionProyectoArea {
    ...
    public static InformacionProyectoArea of(LocalDate fechaInicial, LocalDate fechaFinal, LocalDate fechaRegistro, EPlaneacionSprint planeacionSprint, Integer totalSprint){
        ...
        return new InformacionProyectoArea(fechaInicial, fechaFinal, fechaRegistro, planeacionSprint, totalSprint);
    }

    public InformacionProyectoArea(LocalDate fechaInicial, LocalDate fechaFinal, LocalDate fechaRegistro, EPlaneacionSprint planeacionSprint, Integer totalSprint) {
