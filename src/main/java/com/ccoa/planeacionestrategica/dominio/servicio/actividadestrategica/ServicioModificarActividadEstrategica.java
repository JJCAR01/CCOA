...
public class ServicioModificarActividadEstrategica {
    ...
    public Long modificarDocumento(DocumentoActividadEstrategica documentoActividadEstrategica, Long codigo){
        return this.repositorioActividadEstrategica.modificarDocumento(documentoActividadEstrategica, codigo);
    }
}
