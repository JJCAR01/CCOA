...
import static com.ccoa.planeacionestrategica.dominio.transversal.mensaje.Mensajes.YA_EXISTE_UN_DOCUMENTO_RELACIONADO_CON_LA_ACTIVIDAD_DE_GESTION;
...
public class ServicioGuardarActividadGestionActividadEstrategica {
    ...
    public Long ejecutarGuardarDocumento(DocumentoActividadGestionActividadEstrategica documentoActividadGestionActividadEstrategica, Long codigo){
        if(this.repositorioActividadGestionActividadEstrategica.existeDocumento(documentoActividadGestionActividadEstrategica)) throw new ValorInvalidoExcepcion(YA_EXISTE_UN_DOCUMENTO_RELACIONADO_CON_LA_ACTIVIDAD_DE_GESTION,MENSAJE_DEFECTO);
        return this.repositorioActividadGestionActividadEstrategica.guardarDocumento(documentoActividadGestionActividadEstrategica,codigo);
    }
}
