...
public class ServicioModificarDireccion {
    ...
    public Long ejecutarModificar(Direccion direccion, Long codigo){
        ...
        if(this.repositorioDireccion.consultarPorId(codigo)==null) throw new ValorInvalidoExcepcion(NO_EXISTE_LA_DIRECCION_CON_LOS_DATOS_INGRESADOS,MENSAJE_DEFECTO);
