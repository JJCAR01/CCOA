...
public class ServicioModificarUsuario {
    ...
    public Long ejecutarModificar(Usuario usuario, Rol rol , InformacionUsuario informacionUsuario, Long codigo){
        ...
        if(this.repositorioUsuario.consultarPorId(codigo)==null) throw new ExcepcionValidadorInvalido(NO_EXISTE_EL_USUARIO_CON_LOS_DATOS_INGRESADOS,MENSAJE_DEFECTO);
    ...
    public Long ejecutarModificarDirecciones(InformacionUsuario informacionUsuario,Long codigo){
        ...
        if(this.repositorioUsuario.consultarPorIdParaModificar(codigo)==null) throw new ExcepcionValidadorInvalido(NO_EXISTE_EL_USUARIO_CON_LOS_DATOS_INGRESADOS,MENSAJE_DEFECTO);
