package com.ccoa.planeacionestrategica.infraestructura.adaptador.actividadestrategica.observacion.adaptador.repositorio.impl;
...
import com.ccoa.planeacionestrategica.infraestructura.adaptador.actividadestrategica.observacion.adaptador.mapeador.MapeadorObservacionActividadEstrategica;
import com.ccoa.planeacionestrategica.infraestructura.adaptador.actividadestrategica.observacion.adaptador.repositorio.jpa.RepositorioObservacionActividadEstrategicaJpa;
...
public class RepositorioObservacionActividadEstrategicaMySQL implements RepositorioObservacionActividadEstrategica {
    ...
    public Long eliminar(Long id) {
        this.repositorioObservacionActividadEstrategicaJpa.deleteById(id);
        return id;
    }

    @Override
    public Long modificar(ObservacionActividadEstrategica observacionActividadEstrategica, Long id) {
        var entidad = this.repositorioObservacionActividadEstrategicaJpa.findById(id).orElse(null);
        assert entidad != null;
        this.mapeadorObservacionActividadEstrategica.actualizarEntidad(entidad, observacionActividadEstrategica);
        return this.repositorioObservacionActividadEstrategicaJpa.save(entidad).getIdObservacionActividadEstrategica();
    }
