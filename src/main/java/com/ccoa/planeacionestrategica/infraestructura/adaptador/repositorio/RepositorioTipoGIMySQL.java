...
public class RepositorioTipoGIMySQL implements RepositorioTipoGI {
    ...
    public List<TipoGI> listar() {
        ...
        return entidadTipoGIS.stream().map(entidad -> TipoGI.of(entidad.getIdTipoGI(), entidad.getCantidad(), String.valueOf(entidad.getClasificacion()),
    ...
    public TipoGI consultarPorId(Long id) {
        return this.repositorioTipoGIJpa.findById(id).map(entidad -> TipoGI.of(entidad.getIdTipoGI(), entidad.getCantidad(), String.valueOf(entidad.getClasificacion()),
    ...
    public boolean existe(TipoGI tipoGI) {
        return this.repositorioTipoGIJpa.findById(tipoGI.getIdTipoGI()) != null;
    }
