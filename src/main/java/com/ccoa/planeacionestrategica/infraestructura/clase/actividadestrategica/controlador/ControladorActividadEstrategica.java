package com.ccoa.planeacionestrategica.infraestructura.clase.actividadestrategica.controlador;
...
public class ControladorActividadEstrategica {
    ...
    @GetMapping("/{codigo}")
    public ResponseEntity<ActividadEstrategica> listar(@PathVariable Long codigo){
