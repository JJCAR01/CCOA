...
public class EntidadActividadPrincipal {
    ...
    public EntidadActividadPrincipal(String nombre, String entregable, Double presupuesto, Date fechaInicio, Date fechaFinal,
                                     Date fechaRegistro, EntidadUsuario usuario, EntidadTipoActividad tipoActividad, EntidadTipoGI tipoGI, EntidadLineaEstrategica lineaEstrategica) {
        this.nombre = nombre;
