package com.ccoa.isotools.dominio.modelo.actividadestrategica;
...
class ActividadEstrategicaTest {
    /*@Test
    void validarCreacionExitosa() {
        ...
        ActividadEstrategica epica = ActividadEstrategica.of(idEpica,nombre,fechaInicial,fechaFinal,fechaRegistro,idUsuario,idPat);

        Assertions.assertEquals(1,epica.getIdActividadEstrategica());
