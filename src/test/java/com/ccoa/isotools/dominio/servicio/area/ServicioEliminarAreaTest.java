...
public class ServicioEliminarAreaTest {
    ...
    void verificarAreaExista()
    {
        ...
        Assertions.assertEquals("No existe el Area con los datos ingresados", Assertions.assertThrows(ValorObligatorioExcepcion.class, () -> servicio.ejecutarEliminar(1L)).getMessage());
    }
}
